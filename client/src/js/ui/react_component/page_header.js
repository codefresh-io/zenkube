...
export default (function(dictionary){
    return (uiState, deployments, onBack = _.noop, onDeploymentSelect = _.noop)=>
        header(
            { key: "header" }, [],
            ..._.compact([
                    (dictionary[uiState["main_page"]] || _.constant("N/A"))(uiState, deployments, onDeploymentSelect),
    ...
    [MAIN_PAGE_DEPLOYMENT_REVISION_VIEW]: ({ focused_deployment_revision: r, focused_deployment_id: id }, deployments, onDeploymentSelect)=> span({}, [], ...["Revision ", r.toString(16), " of deployment \"", deploymentName(_(deployments).find({ id }), _.partial(onDeploymentSelect, { id })), "\""])
});